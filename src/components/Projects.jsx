...
<div className='flex flex-wrap  gap-[25px]  items-center w-full mx-auto justify-center'>
    ...
    <Project image={taskImg}  title={"Task Management App"} key={"Task "} description={"A Full stack Task Management Website built using React,Node,Express,MongoDb and TypeScript"} link={"https://taskmanagement-webapp.vercel.app"}/>
